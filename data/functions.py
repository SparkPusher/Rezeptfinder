...
def theme():
    with dpg.theme() as theme:
        with dpg.theme_component(dpg.mvAll):
            ...
            dpg.add_theme_style(dpg.mvStyleVar_WindowPadding, 10, 9, category=dpg.mvThemeCat_Core)
            dpg.add_theme_style(dpg.mvStyleVar_FramePadding, 6, 3, category=dpg.mvThemeCat_Core)
            dpg.add_theme_style(dpg.mvStyleVar_ItemInnerSpacing, 9, 6, category=dpg.mvThemeCat_Core)
